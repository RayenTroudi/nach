...
interface MyConsultationsClientProps {
  serverUserId?: string | null;
}

const MyConsultationsClient = ({ serverUserId }: MyConsultationsClientProps) => {
  ...
  useEffect(() => {
    const fetchConsultations = async () => {
      try {
        const res = await fetch("/api/teacher/my-consultations");
        if (res.ok) {

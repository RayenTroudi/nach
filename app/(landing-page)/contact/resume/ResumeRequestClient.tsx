...
interface ResumeRequestClientProps {
  serverUserId?: string | null;
}

export default function ResumeRequestClient({ serverUserId }: ResumeRequestClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Check if user is authenticated (using serverUserId from server component)
    if (!serverUserId) {
